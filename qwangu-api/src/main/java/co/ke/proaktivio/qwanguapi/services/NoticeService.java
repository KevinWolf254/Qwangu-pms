...
public interface NoticeService {
    ...
    Mono<Notice> findNoticeByOccupationIdAndIsActiveAndGTEVacatingOn(String occupationId, Boolean isActive, LocalDate vacatingOn);
    Mono<Unit> findUnitByAccountNoAndIsBooked(String accountNo, Boolean isBooked);
