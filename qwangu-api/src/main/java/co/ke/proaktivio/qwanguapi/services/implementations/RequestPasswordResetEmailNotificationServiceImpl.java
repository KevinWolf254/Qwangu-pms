...
public class RequestPasswordResetEmailNotificationServiceImpl implements RequestPasswordResetEmailNotificationService {
	...
	public Mono<EmailNotification> create(User user, String token) {
        ...
        resourceMap.put("passwordImage", resources2.get(0));
