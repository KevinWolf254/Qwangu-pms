													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td
																...
																<div align="center" style="line-height:10px"><img
																		alt="I'm an image" src="images/Img4_2x.jpg"
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		...
																		<p
																			...
																			<span
																				style="font-size:30px;color:#2b303a;"><strong>Activate
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td
																...
																<div align="center">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:62px;width:134px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]-->
																	<a href="${accountActivationUrl}"
																		...
																		<span
																			style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
																				style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>Activate
																				</strong></span></span>
																	</a>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td
																...
																<div align="center" style="line-height:10px"><img
																		alt="Alternate text" src="images/Logo-white.png"
																		style="display: block; height: auto; border: 0; width: 149px; max-width: 100%;"
